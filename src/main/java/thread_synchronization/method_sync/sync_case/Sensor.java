...
public class Sensor implements Runnable {
    private thread_synchronization.method_sync.sync_case.ParkingStats parkingStats;

    public Sensor(thread_synchronization.method_sync.sync_case.ParkingStats parkingStats){
